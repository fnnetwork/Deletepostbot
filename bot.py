...
BOT_TOKEN = os.getenv("BOT_TOKEN", "7934676125:AAEghFPs6ti6nzsHkC8oUU5fjzjmOTXMlWw")
API_ID = int(os.getenv("API_ID", "24184946"))
API_HASH = os.getenv("API_HASH", "db7aa8593d6422dd3924f629d6cbe808")
